...
export function WhatsappFloat({
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-4 z-40 flex size-14 items-center justify-center rounded-full bg-neon text-[var(--accent-fg)] shadow-lg transition-transform hover:scale-105 active:scale-[0.98] motion-reduce:transition-none motion-reduce:hover:scale-100"
    >
